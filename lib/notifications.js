...
export async function notifyClientOfMessage({ requestId, requestTitle, clientId, clientEmail, body }) {
  if (clientEmail) {
    await sendEmail({
      to: clientEmail,
...
export async function notifyClientOfDelivery({ requestId, requestTitle, clientId, clientEmail }) {
  if (clientEmail) {
    await sendEmail({
      to: clientEmail,
